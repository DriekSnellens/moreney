...
def render_alphai_command_center(
    ...
    *,
    ...
    return (
        ...
        f"<div class='mini-kpi'><p class='label'>Feature</p>"
        f"<p class='value' id='alphai-feature-score'>{esc(alphai.get('feature_score') or alphai.get('alphai_feature_score') or '—')}</p></div>"
        f"<div class='mini-kpi'><p class='label'>Freshness</p>"
        f"<p class='value' id='alphai-freshness'>{esc(alphai.get('freshness') or alphai.get('alphai_freshness') or '—')}</p></div>"
        f"<div class='mini-kpi'><p class='label'>Shadow feat</p>"
        f"<p class='value' id='alphai-feat-shadow'>{'ja' if alphai.get('alphai_feature_shadow', True) else 'nee'}</p></div>"
        "</div>"
