...
def metrics_from_payload(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "weekly_target_low_eur": 350.0,
        "weekly_target_high_eur": 700.0,
        "weekly_pace_realistic_eur": 50.0,
        "daily_target_low_eur": 50.0,
        "daily_target_high_eur": 100.0,
        "s1_target_low_eur": 20.0,
        "s1_target_high_eur": 45.0,
        "desk_target_low_eur": 50.0,
        "desk_target_high_eur": 100.0,
